...
namespace DbTableEditor.AspNetApp.Controllers
{
    public class RanksController : Controller
    {
        ...
        public RanksController(SpaceshipsContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name")] Rank rank)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name")] Rank rank)
        {
            if (id != rank.Id)
            {
                return NotFound();
